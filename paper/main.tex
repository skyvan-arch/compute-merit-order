...
\begin{itemize}
  ...
  \item \textbf{The compute-price leg is the weakest input.} Public GPU
    rental benchmarks are noisy, vary by contract length and
    availability guarantee, and are not as standardised as wholesale
    power prices; this is flagged wherever the compute price is used.
\end{itemize}
